...
var ThemeCharts = (function () {
  ...
  var colorScheme = (getComputedStyle(document.body).backgroundColor == '#4257b2') ? 'light' : 'dark';
            ...
            custom: function (model) {
              ...
              if (model.body) {
                ...
                bodyLines.forEach(function (body, i) {
                  ...
                  var styles = 'background-color: ' + '#4257b2';
        ...
        doughnut: {
          ...
          legendCallback: function (chart) {
            ...
            data.labels.forEach(function (label, index) {
              ...
              content += '<i class="chart-legend-indicator" style="background-color: ' + '#4257b2' + '"></i>';
              content += label;
              content += '</span>';
            });
