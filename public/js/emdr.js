...
var dataMood, dataSUDS, dataVoC, dataRecall, optionsMain, optionsMood, optionsSUDS, optionsVoC, optionsRecall;
...
var dingAudio = new Audio('sounds/chime.wav');
var coinAudio = new Audio('sounds/coin.flac');
var buzzAudio = new Audio('sounds/buzz.wav');
var beepAudio = new Audio('sounds/beep.wav');
...
function VoC(VoCInput) {
    if (VoCInput == "no") {
        $("#VoCNo").addClass("preset-item-selected");
        $("#VoCYes").removeClass("preset-item-selected");

        document.getElementById("VoCInput").className = "hidden";

        selectedVoC = "no";
    }
    else if (VoCInput == "yes") {
        $("#VoCNo").removeClass("preset-item-selected");
        $("#VoCYes").addClass("preset-item-selected");

        document.getElementById("VoCInput").className = "animated fadeIn margin-top-medium";
...
function switchDirectionSoundPlay() {
    ...
    //switchDirectionSoundPlayer.pause();

    if (switchDirectionSound == "drop") {
        popAudio.play();
    }
    else if (switchDirectionSound == "ding") {
        dingAudio.play();
    }
    else if (switchDirectionSound == "click") {
        coinAudio.play();
    }
    else if (switchDirectionSound == "buzz") {
        buzzAudio.play();
    }
    else if (switchDirectionSound == "beep") {
        beepAudio.play();
    }
}
...
function startEndSession() {
    ...
    //Populate VoC input if active
    if (selectedVoC != "no") {
        var VoC = "";
        VoC += "<div class=\"highlight-color-blue margin-top-tiny\">VoC Score<\/div>";
        VoC += "                            <input onfocusout = \"valueCheck('therapyVoC')\" id=\"VoC-therapy-value\" type=\"number\" class=\"text-input\" placeholder=\"Record VoC (1-7)\" \/>";

        //document.getElementById("your-VoC-box-session").innerHTML = VoC;
        document.getElementById("your-VoC-box-therapy").innerHTML = VoC;
    }
    else {
        document.getElementById("your-VoC-box-therapy").innerHTML = "";
    }
...
function startNextSession() {
    ...
    if (selectedVoC != "no") {
        var VoC = "";
        VoC += "<div class=\"highlight-color-blue margin-top-tiny\">VoC Score<\/div>";
        VoC += "                            <input onfocusout=\"valueCheck('sessionVoC')\" id=\"VoC-session-value\" type=\"number\" class=\"text-input\" placeholder=\"Record VoC (1-7)\" \/>";

        document.getElementById("your-VoC-box-session").innerHTML = VoC;
        document.getElementById("your-VoC-box-therapy").innerHTML = VoC;
    }
    else {
        document.getElementById("your-VoC-box-session").innerHTML = "";
        document.getElementById("your-VoC-box-therapy").innerHTML = "";
    }
...
function valueCheck(valueCheck) {
    ...
    else if (valueCheck == "VoC") {
        if (document.getElementById("VoC-initial").value > 7) {
            document.getElementById("VoC-initial").value = 7;
        }

        if (document.getElementById("VoC-initial").value < 1) {
            document.getElementById("VoC-initial").value = 4;
        }
    }
    ...
    else if (valueCheck == "sessionVoC") {
        if (document.getElementById("VoC-session-value").value > 7) {
            document.getElementById("VoC-session-value").value = 7;
        }

        if (document.getElementById("VoC-session-value").value < 1) {
            document.getElementById("VoC-session-value").value = 4;
        }
    }
    ...
    else if (valueCheck == "therapyVoC") {
        if (document.getElementById("VoC-therapy-value").value > 7) {
            document.getElementById("VoC-therapy-value").value = 7;
        }

        if (document.getElementById("VoC-therapy-value").value < 1) {
            document.getElementById("VoC-therapy-value").value = 4;
        }
    }
...
function saveTherapyResults(type) {
    ...
    if (type != "paused" && type != "ending" && type != "pausedClose") {
        ...
        if (document.getElementById("therapyCheck").checked) {
            ...
            if (selectedVoC != "no") {
                var VoCSave = document.getElementById("VoC-therapy-value").value;
                if (VoCSave.length > 0) {
                    VoCProgress.push(VoCSave);
                    //console.log("suds progress: " + VoCProgress);
                }
                else {
                    VoCProgress.push("empty");
                }
            }
            ...
            if (selectedVoC == "yes") {
                if (!isNaN(calculateAverageScore(VoCProgress))) {
                    sessionVoCAverage = calculateAverageScore(VoCProgress);
                }
                else {
                    sessionVoCAverage = "empty";
                }
            }
            else {
                sessionVoCAverage = "empty";
            ...
            firebase.database().ref('users/' + user.uid + "/emdr" + "/therapyResults" + "/" + timeSet).set({
                ...
                averageVoCAverage: sessionVoCAverage
            });
        }
    }
    ...
    if (type == "ending") {
        if (document.getElementById("sessionCheck").checked) {
            ...
            if (selectedVoC != "no") {
                var VoCSave = document.getElementById("VoC-session-value").value;
                if (VoCSave.length > 0) {
                    VoCProgress.push(VoCSave);
                    //console.log("suds progress: " + VoCProgress);
                }
...
function calculateSessionCount(array, type) {
    if (type == "mood") {
        ...
        for (var i = 0; i <= yourCurrentSession; i++) {
            if (array[i] != "empty") {
                if (i == 0) {
                    numberOfSessionsDataVoC.push("Initial");
                }
                else {
                    numberOfSessionsDataVoC.push(i.toString());
                }
            }
        }
    }
...
function analyzeSession() {
    ...
    document.getElementById("analysis-VoC").className = "hide-analysis";
    ...
    if (selectedVoC == "yes") {
        calculateSessionCount(VoCProgress, "VoC");
        convertToInt(VoCProgress);
    }

    longestData(convertToInt(numberOfSessionsDataMood), convertToInt(numberOfSessionsDataRecall), convertToInt(numberOfSessionsDataSuds), convertToInt(numberOfSessionsDataVoC));
    ...
    if ((selectedSUDS == "yes" && numberOfSessionsDataSuds.length > 0) && (selectedVoC == "yes" && numberOfSessionsDataVoC.length > 0)) {
        document.getElementById("analysis-suds").className = "col col-12 col-md-6 col-lg-6 margin-top-large visible";
        document.getElementById("analysis-VoC").className = "col col-12 col-md-6 col-lg-6 margin-top-large visible";

        document.getElementById("average-suds").innerHTML = calculateAverageScore(sudsProgress);
        document.getElementById("average-VoC").innerHTML = calculateAverageScore(VoCProgress);
    }
    else if ((selectedSUDS == "yes" && numberOfSessionsDataSuds.length <= 0) && (selectedVoC == "yes" && numberOfSessionsDataVoC.length > 0)) {
        document.getElementById("analysis-suds").className = "col col-12 margin-top-large hide-analysis";
        document.getElementById("analysis-VoC").className = "col col-12 margin-top-large visible";
        ...
        document.getElementById("analysis-VoC").className = "col col-12 col-md-6 col-lg-6 margin-top-large hide-analysis";

        document.getElementById("average-suds").innerHTML = calculateAverageScore(sudsProgress);
    }

    else if ((selectedSUDS == "yes" && numberOfSessionsDataSuds.length > 0) && (selectedVoC != "yes")) {
    ...
    else if ((selectedSUDS != "yes") && (selectedVoC == "yes" && numberOfSessionsDataVoC.length > 0)) {
    ...
    dataVoC = {
        labels: numberOfSessionsDataVoC,
        datasets: [{
            label: 'VoC value',
            backgroundColor: gradient,
            hoverBackgroundColor: "#4257b2",
...
function startSession() {
    ...
    if (selectedVoC != "no") {
        var VoCSave = document.getElementById("VoC-initial").value;
        if (VoCSave.length > 0) {
            VoCProgress.push(VoCSave);
        }
        else {
...
function loadSet(set) {
    ...
    desc.once('value', function (snapshot) {
        ...
        if (snapshot.val().VoC != "no") {
            VoC("yes");
            document.getElementById("VoC-initial").value = snapshot.val().VoC;
        }
        else {
            VoC("no");
        }
...
function updateSet(updatedSet) {
    ...
    if (selectedVoC == "yes") {
        selectedVoC = document.getElementById("VoC-initial").value;
    }
