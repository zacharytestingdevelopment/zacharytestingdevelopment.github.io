...
function openYourProfile() {
    $("#your-account-panel").addClass("analysis-box-visible");
    $("#your-account-panel").removeClass("analysis-box-hidden");
}

function closeYourProfile() {
    $("#your-account-panel").removeClass("analysis-box-visible");
    $("#your-account-panel").addClass("analysis-box-hidden");
}
